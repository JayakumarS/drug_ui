...
@Component({
  selector: 'app-list-drug-info',
  templateUrl: './list-drug-info.component.html',
  styleUrls: ['./list-drug-info.component.sass']
})
export class ListDrugInfoComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  displayedColumns = [
   // "select",
    "ndcupc",
    "mfgCode",
  ...
  editCall(row) {
    this.router.navigate(['/setup/drugInfo/AddDrugInfo/'+ row.cusCode]);
  }
